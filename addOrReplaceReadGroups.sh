...
java  -Xmx40g -jar ${PICARD} AddOrReplaceReadGroups INPUT=/staging/biology/yoda670612/$1.marked.bam OUTPUT=/staging/biology/yoda670612/$1.marked.addmarked.bam RGID=1 RGLB=lib1 RGPL=illumina RGPU=unit1 RGSM=20
