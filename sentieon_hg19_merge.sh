...
# ******************************************
$SENTIEON_INSTALL_DIR/bin/sentieon driver -t $nt -i ${SampleName}.bam --algo LocusCollector --fun score_info ${SampleName}.score.txt
$SENTIEON_INSTALL_DIR/bin/sentieon driver -t $nt -i ${SampleName}.bam --algo Dedup --rmdup --score_info ${SampleName}.score.txt --metrics ${SampleName}.dedup_metrics.txt ${SampleName}.deduped.bam
